...
const HomePageThree = () => {
  return (
    <Fragment>
      ...
      <HeroSlider sliders={heroSliders} className="heroSliderArea heroSliderAreaStyleThree" />
      <Service className="serviceArea" />
      <About className="aboutArea" title="About Us" images={about} signature={signature} pragraphs={aboutText} />
      <ServiceArea
